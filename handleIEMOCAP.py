...
PATH_TXT = glob.glob("E:/IEMOCAP_full_release/*/dialog/EmoEvaluation/S*.txt")
PATH_WAV = glob.glob("E:/IEMOCAP_full_release/*/sentences/wav/*/S*.wav")
...
if __name__ == '__main__':
    pairPath = "E:/IEMOCAP_full_release/pair.json"
